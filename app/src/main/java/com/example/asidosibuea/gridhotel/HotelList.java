...
public class HotelList extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        while (cursor.moveToNext()) {
            ...
            list.add(new Hotel(id, name, address, image));
        }
...
//        });
    ...
    private void showDialogUpdate(Activity activity, final int position){
        ...
        imageViewHotel = (ImageView) dialog.findViewById(R.id.imageViewHotel);
            ...
            public void onClick(View v) {
                try {
                    MainActivity.sqLiteHelper.updateData(
                            ...
                            MainActivity.imageViewToByte(imageViewHotel),
                            position
                    );
                    dialog.dismiss();
    ...
    private void updateFoodList(){
        ...
        while (cursor.moveToNext()) {
            ...
            list.add(new Hotel(id, name, price, image));
        }
        adapter.notifyDataSetChanged();
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 888 && resultCode == RESULT_OK && data != null){
            ...
            try {
                ...
                imageViewHotel.setImageBitmap(bitmap);
